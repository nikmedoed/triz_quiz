...
- Модератор переключается далее. Ответы более не принимаются, бот сообщает об этом.
- Если идей нет, на экране написано, что ответов нет, модератор может нажать далее и перейти на следующий вопрос.
- Если ответы есть, то на экране высвечивается список ответов в анонимном виде пронумерованные, в боте активируется
  режим голосования. ОН присылает сообщение: начато голосование за
